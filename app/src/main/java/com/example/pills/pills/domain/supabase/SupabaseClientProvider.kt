...
//    private const val SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InloYm1ob3F2cWFqZ3Fzb3dpaGFnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTI5ODEwMDgsImV4cCI6MjA2ODU1NzAwOH0.r2eDAzsAFZx8EiLhG6biOrqZ9lSkovo5bpkIvMpuLus"
    ...
    private const val SUPABASE_URL = "https://dqemuptnebbtwcktslap.supabase.co"
    private const val SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRxZW11cHRuZWJidHdja3RzbGFwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTMxOTIzMjUsImV4cCI6MjA2ODc2ODMyNX0.3qmJRSdpiMcuPYMgM8odG5XcW2yssCCEVn6AsgvmHAc"

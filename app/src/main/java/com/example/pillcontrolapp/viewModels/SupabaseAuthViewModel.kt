package com.example.pillcontrolapp.viewModels
...
import com.example.pillcontrolapp.client.SupabaseClient
import com.example.pillcontrolapp.models.UserState
import com.example.pillcontrolapp.utils.SharedPreferenceHelper
...
class SupabaseAuthViewModel :  ViewModel() {
    ...
    fun logout(context: Context) {
        ...
        viewModelScope.launch {
            try {
                _userState.value = UserState.Loading
                SupabaseClient.client.auth.close()
